...
echo "python -m neuromod_recursive.run_search --single --use-fineweb --preset fineweb_medium --steps 5000 --seq-len 1024"
echo ""
echo "# 2. Mini evolutionary search (~2 hours on 1x H100):"
echo "python -m neuromod_recursive.run_search --use-fineweb --preset fineweb_medium --population 10 --generations 5 --steps 1000 --seq-len 1024"
echo ""
echo "# 3. Full evolutionary search (~10-20 hours on 1x H100):"
echo "python -m neuromod_recursive.run_search --use-fineweb --preset fineweb_large --population 30 --generations 20 --steps 2000 --seq-len 1024"
echo ""
echo "# 3b. Same large preset with an explicit batch-size override:"
echo "python -m neuromod_recursive.run_search --use-fineweb --preset fineweb_large --batch-size 12 --single --steps 5000 --seq-len 1024"
echo ""
